# -*- encoding: utf-8 -*-
# stub: unicode-display_width 3.3.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.date = "1980-01-02"
  s.description = "[Unicode 18.0.0] Determines the monospace display width of a string using EastAsianWidth.txt, Unicode general category, Emoji specification, and other data.".freeze
  ...
  s.add_runtime_dependency(%q<unicode-emoji>.freeze, ["~> 4.3"])
